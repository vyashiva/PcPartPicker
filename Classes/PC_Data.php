...
class PC_Data
{
    ...
    public static function Get_PC_Data(){
        ...
        $data = array(
            ...
            'windows_version' => self::get_os(),
            'OS64Bit' => self::check_If_64_Bit_OS(),
    ...
    private static function check_If_64_Bit_OS(){
    ...
    private static function get_PC_Name(){
        return gethostname();
    }

    private static function get_Host_Name(){
        return gethostname();
    }
}
